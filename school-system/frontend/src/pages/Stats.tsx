...
// Kombinationsfilter: erst alle nach Student, dann nach Subject filtern
    ...
    <table className="w-full border-collapse border border-gray-300">
      <thead className="bg-gray-200">
        <tr>
          ...
          <th className="border p-2">Schüler-ID</th>
          <th className="border p-2">Fach</th>
          <th className="border p-2">Höchste Note</th>
          <th className="border p-2">Niedrigste Note</th>
          <th className="border p-2">Durchschnitt</th>
        </tr>
      </thead>
      <tbody>
        {stats.map((s) => (
          <tr key={s.id} className="hover:bg-gray-50">
            ...
            <td className="border p-2">{s.highestGrade}</td>
            <td className="border p-2">{s.lowestGrade}</td>
            <td className="border p-2">{s.averageGrade.toFixed(2)}</td>
          </tr>
        ))}
      </tbody>
    </table>
